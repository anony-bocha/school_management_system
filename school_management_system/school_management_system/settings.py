...
SECRET_KEY = 'django-insecure-77y-y19a*mpvir+j^oha#ar!jpqn4-p48jzi)_a@krx&tczk!$'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.request',  # needed for login forms
...
# Media files (User uploaded files, e.g. student photos)
MEDIA_URL = '/media/'
